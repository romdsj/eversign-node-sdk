...
function Document(newDocument = {}) {
  ...
  this.getTitle = function (newTitle) {
  ...
  this.getMessage = function (newMessage) {
  ...
  this.getUseSignerOrder = function (newUseSignerOrder) {
  ...
  this.getReminders = function (newReminders) {
  ...
  this.getRequireAllSigners = function (newRequireAllSigners) {
  ...
  this.getRedirect = function (newRedirect) {
  ...
  this.getClient = function (newClient) {
  ...
  this.getExpires = function (newExpires) {
